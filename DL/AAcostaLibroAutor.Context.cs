...
namespace DL
{
    ...
    public partial class AAcostaLibroAutorEntities : DbContext
    {
        public AAcostaLibroAutorEntities()
            : base("name=AAcostaLibroAutorEntities")
        {
        }
        ...
        public virtual int LibroAdd(string nombre, string fechaPublicacion, string numeroPaginas, Nullable<int> idAutor)
        {
            ...
            var numeroPaginasParameter = numeroPaginas != null ?
                new ObjectParameter("NumeroPaginas", numeroPaginas) :
                new ObjectParameter("NumeroPaginas", typeof(string));
        ...
        public virtual int LibroUpdate(Nullable<int> idLibro, string nombre, string fechaPublicacion, string numeroPaginas, Nullable<int> idAutor)
        {
            var idLibroParameter = idLibro.HasValue ?
                new ObjectParameter("IdLibro", idLibro) :
                new ObjectParameter("IdLibro", typeof(int));
